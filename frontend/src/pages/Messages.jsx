...
function Messages() {
  ...
  return (
    ...
    <div className='w-full min-h-[100vh] flex flex-col bg-gray-50 gap-[20px] p-[10px]'>
      <div className='w-full h-[80px]  flex items-center gap-[20px] px-[20px]'>

        <MdOutlineKeyboardBackspace className='text-black cursor-pointer lg:hidden w-[25px]  h-[25px] ' onClick={() => navigate(`/`)} />
        <h1 className='text-black text-[20px] italic font-semibold'>Messages</h1>
      </div>

      <div className='w-full h-[80px] flex gap-[20px] justify-start mt-[-90px] items-center overflow-x-auto p-[20px] border-b-2 border-gray-200'>
        ...
        {prevChatUsers?.map((user, index) => (
          <div className='text-white cursor-pointer w-full flex  items-center gap-[10px]' onClick={() => {
            ...
            <div className='flex flex-col'>
              <div className='text-black text-[18px] font-semibold'>{user.userName}</div>
