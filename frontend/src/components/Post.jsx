...
socket?.on("commentedPost",(updatedData)=>{
  ...
  return (
    <div className='w-[90%]  flex flex-col gap-[10px] bg-white items-center shadow shadow-[#00000058] rounded-2xl pb-[20px]'>
      <div className='w-full h-[80px] flex justify-between items-center px-[10px]'>
       ...
       {userData._id!=post.author._id &&  <FollowButton tailwind={'px-[10px] minw-[60px] md:min-w-[100px] py-[5px] h-[30px] cursor-pointer md:h-[40px] bg-blue-600 hover:scale-98 transition-all duration-100 hover:bg-blue-700 text-white rounded-3xl shadow  text-[14px] md:text-[16px]'} targetUserId={post.author._id}/>}
      ...
      {post.caption && <div className='w-full px-[20px] gap-[10px] flex justify-start items-center '>
        ...
        {/*<h1>{post.author.userName ||dp}</h1> COMMENTED AREA FOR AUTHOR NAME IN POST*/ }
      ...
      {showComment &&
        <div className='w-full  flex flex-col gap-[30px] pb-[20px]'>
          ...
          <input type="text" className='px-[10px] border-b-2 border-b-gray-200 w-[90%] outline-none h-[40px]' placeholder='Write comment...' onChange={(e)=>setMessage(e.target.value)} value={message}/>
