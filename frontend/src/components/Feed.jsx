...
function Feed() {
  ...
  return (
    <div className='lg:w-[50%] w-full bg-gray-100 min-h-[100vh] lg:h-[100vh] relative lg:overflow-y-auto '>
      <div className='w-full h-[100px] flex items-center justify-between p-[20px] lg:hidden'>
        <img src={logo} alt="" className='w-[80px]' />
        <div className='flex items-center gap-[10px]'>
          <div className='relative' onClick={() => navigate("/notifications")}>
            <FaRegHeart className='text-[black] cursor-pointer w-[25px] h-[25px]' />
          ...
          <BiMessageAltDetail className='text-[black]  cursor-pointer  w-[25px] h-[25px]' onClick={() => navigate("/messages")} />
        </div>
      </div>
